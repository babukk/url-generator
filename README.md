...
TODO:
- Нужно добавить обработку exceptions для работы с БД.
- Для 'боевого' применения потребуется добавить авторизацию, например, по token'у, который можно генерировать на определенный период времени по логину-паролю.
- Можно было бы добавить возможность 'постраничного' вывода массива 'всех книг' с возможностью задания 'страницы' и 'строк на странице' - на случай если БД будет очень большой.
- Удаление еще можно добавить. По id и по slug.
```
